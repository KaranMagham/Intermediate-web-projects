...
const Contact = () => {
  return (
    <div className='w-full h-full bg-gradient-to-b from-black via-[#1f1f1f] to-[#383838] text-red-500 overflow-y-auto'>
      ...
      {/* Sticky Header */}
      <div className="sticky top-0 bg-black underline z-10 py-4">
        <Link to="/contact" className='text-red-500 text-3xl px-3 font-bold cursor-pointer hover:text-red-400 transition-all duration-300'>
          Contact.
        </Link>
